...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="callout callout-info">
					<b class="border-bottom border-primary">Luggage Details</b>
						<div class="row">
							<div class="col-sm-6">
								<dl>
									<dt>Wight:</dt>
					...
					<dl>
						<dt>Branch Accepted the Luggage:</dt>
						...
						<dd>
							...
							switch ($status) {
								...
								default:
									echo "<span class='badge badge-pill badge-info'> Item Accepted by Luggage</span>";
